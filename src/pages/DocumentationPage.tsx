...
// Import all documentation pages from central export
import {
  GettingStartedPage,
  GettingStartedGuidePage,
  AIFrameworkPage,
  AIFrameworkGuidePage,
  DevilSecurityPage,
  SecurityFrameworkPage,
  SecurityFrameworkGuidePage,
  CloudIntegrationPage,
  BrolostackWorkerPage,
  BrolostackWorkerGuidePage,
  WebSocketFrameworkPage,
  WebSocketFrameworkGuidePage,
  BrolostackWSClientPage,
  BrolostackWSMultiAgentPage,
  CIAMIntegrationPage,
  AuthenticationGuidePage,
  BackendIntegrationPage,
  BackendIntegrationGuidePage,
  EnterpriseFeaturesPage,
  EnterpriseFeaturesGuidePage,
  EnvironmentManagementPage,
  EnvironmentManagementGuidePage,
  TokenUsageControlPage,
  TokenUsageControlGuidePage,
  BrowserCompatibilityPage,
  BrowserCompatibilityGuidePage,
  BrowserPrivateModePage,
  FrameworkStatusPage,
...
const DocumentationPage: React.FC = () => {
  ...
  useEffect(() => {
    const checkScreenSize = () => {
      ...
      // On desktop, sidebar is always open and static
  ...
  // Handle sidebar toggle - only allow closing on mobile
  const toggleSidebar = () => {
      ...
      <div className="flex min-h-screen">
        ...
        <AnimatePresence>
          {(isSidebarOpen || window.innerWidth >= 1024) && (
            <motion.aside 
              className={`fixed lg:static inset-y-0 left-0 z-40 w-72 sm:w-80 bg-white border-r border-gray-200 flex flex-col ${
                isSidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
              } transition-transform duration-300 ease-in-out lg:top-20 lg:h-[calc(100vh-5rem)] lg:translate-x-0`}
              initial={{ x: -320 }}
              animate={{ x: 0 }}
              exit={{ x: -320 }}
            >
        ...
        {/* Main Content */}
        <main className="flex-1 lg:ml-80 lg:flex-none lg:w-auto">
